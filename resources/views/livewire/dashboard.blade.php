                ...
                <div class="mb-6">
                    ...
                    >
                        ...
                        <optgroup label="Lesen (alle Rollen)">
                            ...
                            <option value="view-categories">Alle Kategorien anzeigen</option>
                        </optgroup>
                    ...
                    <form wire:submit.prevent="executeAction" class="space-y-4">
                        ...
                        @if($selectedAction === 'delete-product')
                            <div class="space-y-4">
                                ...
                                <p class="mt-1 text-sm text-red-600 font-semibold">Achtung: Diese Aktion kann nicht rückgängig gemacht werden!</p>
                            </div>
                        @endif
                        ...
                        @if($selectedAction === 'create-product')
                            <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                                ...
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-2">Kategorie-ID *</label>
                                    <input 
                                        wire:model="categoryIdForCreate"
                                        type="text" 
                                        class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                                        placeholder="z.B. 1"
                                    >
                        ...
                        @if($selectedAction === 'create-category')
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">Kategoriename *</label>
                                <input 
                                    wire:model="categoryNameForCreate"
                                    type="text" 
                                    class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                        ...
                        @if($selectedAction === 'delete-category')
                            <div class="space-y-4">
                                    ...
                                    <div class="flex">
                                        ...
                                        <div class="ml-3">
                                            ...
                                            <div class="mt-2 text-sm text-red-700">
                                                <p>Das Löschen einer Kategorie löscht auch <strong>alle Produkte</strong> in dieser Kategorie!</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-2">Kategoriename zur Bestätigung *</label>
                                    <input 
                                        wire:model="categoryName"
                                        type="text" 
                                        class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                                    ...
                                    >
                                    <p class="mt-1 text-sm text-red-600">Sicherheitsabfrage: Name muss exakt übereinstimmen!</p>
                                </div>
                            </div>
                        @endif
                        ...
                        @if($selectedAction === 'stock-adjustment')
                            <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                                ...
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-2">Anpassung * (+/- Stück)</label>
                                    <input 
                                    ...
                                    >
                                    <p class="mt-1 text-sm text-gray-500">Negative Werte reduzieren, positive erhöhen den Bestand</p>
                                </div>
                            </div>
                        @endif
                                ...
                                <div class="border-t border-gray-200">
                                    <dl>
                                        ...
                                        <div class="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                                            ...
                                            <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">{{ \Carbon\Carbon::parse($result->created_at)->format('d.m.Y H:i') }}</dd>
                                        </div>
                                    </dl>
                                </div>
                            </div>
                                ...
                                <div class="border-t border-gray-200">
                                    <dl>
                                        ...
                                        <div class="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                                            ...
                                            <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">{{ $result->isbn }}</dd>
                                        </div>
                                        @endif
                                        <div class="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                                            <dt class="text-sm font-medium text-gray-500">Lagerbestand</dt>
                                            <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                                                <flux:badge :color="$result->count == 0 ? 'red' : ($result->count < 10 ? 'yellow' : 'green')">
                                                    {{ $result->count }} Stück
                                                </flux:badge>
                                            </dd>
                                        </div>
                                        ...
                                        <div class="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                                            ...
                                            <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">{{ $result->manufacturer }}</dd>
                                        </div>
                                        @endif
                                        @if(isset($result->supplier) && $result->supplier)
                                        <div class="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                                            <dt class="text-sm font-medium text-gray-500">Lieferant</dt>
                                            <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">{{ $result->supplier }}</dd>
                                        </div>
                                        @endif
                                        <div class="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                                            <dt class="text-sm font-medium text-gray-500">Preis</dt>
                                            <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2 font-semibold">{{ number_format($result->price, 2, ',', '.') }} €</dd>
                                        </div>
                                        @if(isset($result->last_supplied_at) && $result->last_supplied_at)
                                        <div class="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                                            <dt class="text-sm font-medium text-gray-500">Letzte Lieferung</dt>
                                            <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">{{ \Carbon\Carbon::parse($result->last_supplied_at)->format('d.m.Y H:i') }}</dd>
                                        </div>
                                        @endif
                                        ...
                                        <div class="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                                            ...
                                            <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                                                <flux:badge color="blue">
                                                    {{ $result->category->name ?? 'N/A' }} (ID: {{ $result->category->id ?? 'N/A' }})
                                                </flux:badge>
                                            </dd>
                                        </div>
                                        @endif
                                            ...
                                            <table class="min-w-full divide-y divide-gray-200">
                                                <thead class="bg-gray-50">
                                                    <tr>
                                                        ...
                                                        <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Bestand</th>
                                                        <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Preis</th>
                                                        <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Hersteller</th>
                                                        <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Lieferant</th>
                                                        <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Letzte Lieferung</th>
                                                    </tr>
                                                </thead>
                                                <tbody class="bg-white divide-y divide-gray-200">
                                                    @forelse($products as $product)
                                                        ...
                                                        @endphp
                                                        <tr>
                                                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">{{ $prod->id ?? 'N/A' }}</td>
                                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{{ $prod->name ?? 'N/A' }}</td>
                                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ $prod->isbn ?? '-' }}</td>
                                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                                                @if(isset($prod->category))
                                                                    <flux:badge color="blue">
                                                                        {{ is_object($prod->category) ? $prod->category->name : ($prod->category['name'] ?? 'N/A') }}
                                                                        (ID: {{ is_object($prod->category) ? $prod->category->id : ($prod->category['id'] ?? 'N/A') }})
                                                                    </flux:badge>
                                                                @else
                                                                    -
                                                                @endif
                                                            ...
                                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                                                <flux:badge :color="$count == 0 ? 'red' : ($count < 10 ? 'yellow' : 'green')" class="{{ $count <= 5 ? 'ring-2 ring-red-600' : '' }}">
                                                                    {{ $count }} Stück
                                                                </flux:badge>
                                                            </td>
                                                            <td class="px-6 py-4 whitespace-nowrap text-sm font-semibold text-gray-900">{{ number_format($prod->price ?? 0, 2, ',', '.') }} €</td>
                                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ $prod->manufacturer ?? '-' }}</td>
                                                    ...
                                                    @empty
                                                        <tr>
                                                            <td colspan="9" class="px-6 py-4 text-center text-sm text-gray-500">Keine Produkte gefunden</td>
                                                        </tr>
                                                    @endforelse
                                                </tbody>
                                            </table>
                                        ...
                                        <div class="ml-3">
                                            ...
                                            <div class="mt-2 text-sm text-red-700">
                                                ...
                                                <ul class="list-disc list-inside space-y-1">
                                                    <li><strong>Kategorie-ID:</strong> {{ $deleteResult->category_id ?? 'N/A' }}</li>
                                                    <li><strong>Kategoriename:</strong> {{ $deleteResult->category_name ?? 'N/A' }}</li>
                                                    <li><strong>Gelöschte Produkte:</strong> {{ $deleteResult->deleted_products_count ?? 0 }}</li>
                                                    <li class="mt-2 text-red-600 font-semibold">{{ $deleteResult->message ?? 'Kategorie wurde gelöscht.' }}</li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="overflow-x-auto">
                                        <table class="min-w-full divide-y divide-gray-200">
                                            <thead class="bg-gray-50">
                                                <tr>
                                                    <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">ID</th>
                                                    <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Kategoriename</th>
                                                    <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Gesamt Produkte</th>
                                                    <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Niedriger Bestand (&lt;10)</th>
                                                    <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Nicht vorrätig</th>
                                            ...
                                            <tbody class="bg-white divide-y divide-gray-200">
                                                @forelse($result as $category)
                                                    <tr class="hover:bg-gray-50">
                                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-semibold text-gray-900">{{ $category->id }}</td>
                                                        ...
                                                        <td class="px-6 py-4 text-sm">
                                                            @if($category->productsWithLowStock && $category->productsWithLowStock->count() > 0)
                                                                <div class="flex flex-col space-y-1">
                                                                    @foreach($category->productsWithLowStock as $product)
                                                                        <span class="inline-flex items-center px-2 py-1 rounded text-xs bg-yellow-50 text-yellow-800 border border-yellow-200 w-fit">
                                                            ...
                                                            @if($category->productsOutOfStock && $category->productsOutOfStock->count() > 0)
                                                                <div class="flex flex-col space-y-1">
                                                                    @foreach($category->productsOutOfStock as $product)
                                                                        <span class="inline-flex items-center px-2 py-1 rounded text-xs bg-red-50 text-red-800 border border-red-200 w-fit">
                                                                            {{ $product->name }}
                                                                        </span>
                                                                    @endforeach
                                                                </div>
                                                ...
                                                @empty
                                                    <tr>
                                                        <td colspan="6" class="px-6 py-4 text-center text-sm text-gray-500">Keine Kategorien vorhanden</td>
                                                    </tr>
                                                @endforelse
                                            </tbody>
                                        </table>
